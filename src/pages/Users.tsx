              ...
              <TableBody>
                {filteredUsers.map((user: any) => (
                  <TableRow key={user.id}>
                    ...
                    <TableCell>
                      <Badge variant={user.active ? "default" : "secondary"} className={user.active ? "bg-green-500 hover:bg-green-500/90" : ""}>
                    ...
                    <TableCell>
                      {user.role === "admin" ? (
                        ...
                        <span>
                          {user.allowedMountpoints && user.allowedMountpoints.length > 0
